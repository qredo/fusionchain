...
GO111MODULES=on \
go build \
-ldflags "-w -linkmode external -extldflags '-static' -X 'github.com/qredo/fusionchain/mpc-relayer/pkg/common/constants.linkedDate=$build_date' -X 'github.com/qredo/fusionchain/mpc-relayer/pkg/common/constants.linkedCommit=$commit_hash'"