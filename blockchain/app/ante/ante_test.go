	...
	testCases := []struct {
		...
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder := suite.CreateTestEIP712TxBuilderMsgSend(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder := suite.CreateTestEIP712TxBuilderMsgDelegate(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgCreateValidator(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgCreateValidator2(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder := suite.CreateTestEIP712SubmitProposal(from, privKey, "qredofusiontestnet-0", gas, gasAmount, deposit)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				suite.Require().NoError(err)
				return suite.CreateTestEIP712SingleMessageTxBuilder(privKey, "qredofusiontestnet-0", gas, gasAmount, msg).GetTx()
			}, false, false, true,
		},

		{
			...
			func() sdk.Tx {
				...
				gasAmount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712GrantAllowance(from, privKey, "qredofusiontestnet-0", gas, gasAmount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgEditValidator(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgSubmitEvidence(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712SubmitProposalV1(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgExec(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgVoteV1(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MultipleMsgSend(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MultipleSignerMsgs(from, privKey, "qredofusiontestnet-0", gas, amount)
				return txBuilder.GetTx()
			}, false, false, false,
		},
		{
